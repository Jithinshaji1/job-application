    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="contact-info">
          ...
          <p>Email: <a href="mailto:contact@yourcompany.com">asapjobs@contact.com</a></p>
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear}ASAP-Jobs. All rights reserved. | <a href="/privacy">Privacy Policy</a> | <a href="/terms">Terms of Use</a></p>
      </div>
    </footer>
</div>
  );
